...
![icon](Pasted%20image%2020211203132930.png)
...
![Alt_Text](Pasted%20image%2020211203133049.png)
...
![Alt_Text](Pasted%20image%2020211203133659.png)
...
![Alt_Text](Pasted%20image%2020211203135345.png)
* But now we fail a second check:
![Alt_Text](Pasted%20image%2020211203135431.png)
* This time, the string we need to match is not showing plain in the code:
![Alt_Text](Pasted%20image%2020211203162109.png)
...
![Alt_Text](Pasted%20image%2020211203161041.png)
```bash
...
![Alt_Text](Pasted%20image%2020211203162628.png)
...
![Alt_Text](Pasted%20image%2020211203230826.png)
...
![Alt_Text](Pasted%20image%2020211204145508.png)
...
![Alt_Text](Pasted%20image%2020211204150303.png)
* We started by analyzing method a: from the source, it became clear that method a performs the following actions on the message sent by us:
   ...
   And got the plain:
	![Alt_Text](Pasted%20image%2020211204155907.png)
...
![Alt_Text](Pasted%20image%2020211204160119.png)
...
![Alt_Text](Pasted%20image%2020211204170007.png)
